...
function fireConfetti() {
  const colors = ["#ffc46b", "#f59f1d", "#35d0ba", "#7fd7e8", "#e9f0f6"];
...
export default function App() {
  ...
  const chip =
    phase === "running"
      ? { text: "отсчёт идёт", dot: "bg-lagoon", cls: "text-lagoon border-lagoon/30" }
      : phase === "finished"
  ...
  return (
    ...
    >
      <Ripple
        ...
        trigger="click"
      >
        <div className="scene-bg noise relative flex h-full flex-col overflow-hidden">
          {/* уголки-метки */}
          {[
            "left-4 top-16",
            "right-4 top-16",
          ...
          <main className="relative z-10 flex min-h-0 flex-1 flex-col items-center justify-center px-4">
            ...
            >
              ...
              >
                ...
                />
                <path d="M100 1v8M100 191v8M1 100h8M191 100h8" stroke="#2c3f52" strokeWidth="1" />
              </svg>
            </div>
            ...
            <div className="fade-up relative flex flex-col items-center" style={{ animationDelay: "0.08s" }}>
                  ...
                  {phase === "finished" ? (
                    <div className="flex flex-col items-center gap-4">
                      <span className="pulse-ring flex items-center gap-3 rounded-full border border-alarm/40 bg-alarm/10 px-6 py-2.5">
                        ...
                        <span className="alarm-flash font-display text-lg font-semibold tracking-[0.28em] text-alarm uppercase sm:text-2xl">
                          Время вышло
                        </span>
                      </span>
                      <TimerDigits
                    ...
                    <TimerDigits
                      ...
                      sizeClass="text-[clamp(2.1rem,7.6vw,5.4rem)]"
                    />
                  )}
              ...
              <div className="mt-8 flex items-center gap-3">
                <button
                  ...
                  className="btn-ghost flex items-center gap-2.5 rounded-md border border-flare/60 bg-flare/15 px-6 py-3 font-display text-[12px] font-semibold tracking-[0.16em] text-ember uppercase shadow-[0_0_36px_rgba(245,159,29,0.14)]"
                >
