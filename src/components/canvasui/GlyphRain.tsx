/**
 * GlyphRain — Canvas UI (https://canvasui.dev)
 * Rains glowing glyph streams over your live HTML while every drop head
 * casts a pool of light onto the page beneath. In browsers without
 * html-in-canvas support it degrades to a pure WebGL glyph overlay —
 * content stays regular, interactive HTML.
 */
import {
  useEffect,
  useRef,
...
export function GlyphRain({
  ...
  const [initialOptions] = useState<GlyphRainOptions>(options);
